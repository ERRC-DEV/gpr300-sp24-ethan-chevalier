...
namespace ec
{
	...
	std::vector<ew::Transform> Skeleton::CalcChildrenPos()
	{
		...
		shoulderTransform.position = glm::vec3((torsoTransform.scale.x * mShoulder->scale.x), (torsoTransform.scale.y * mShoulder->scale.y), (torsoTransform.scale.z * mShoulder->scale.z));
		...
		elbowTransform.position = glm::vec3((shoulderTransform.scale.x * mElbow->scale.x), (shoulderTransform.scale.y * mElbow->scale.y), (shoulderTransform.scale.z * mTorso->scale.z));
		...
		wristTransform.position = glm::vec3((elbowTransform.scale.x * mWrist->scale.x), (elbowTransform.scale.y * mWrist->scale.y), (elbowTransform.scale.z * mWrist->scale.z));
